...
const unitsCopy: Record<Locale, Record<string, UnitCopy>> = {
  pt: {
    "ambientes-inteligentes": {
      ...
      description:
        "Soluções de videomonitoramento com IA, controle de acesso e gestão de alarmes para proteger patrimônio, pessoas e operações corporativas, com a plataforma operando 24x7 e alertando sua equipe.",
