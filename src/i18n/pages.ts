...
export const pages = {
  pt: {
    ...
    comecar: {
      ...
      titleB: "Uma plataforma.",
      lead: "A mesma engenharia atende a cidade e a operação privada — o que muda é o problema que ela resolve.",
      cta: "Entrar por aqui",
  ...
  en: {
    ...
    comecar: {
      ...
      titleA: "Two contexts.",
      titleB: "One platform.",
      lead: "The same engineering serves the city and the private operation — what changes is the problem it solves.",
      cta: "Start here",
  ...
  es: {
    ...
    comecar: {
      ...
      titleB: "Una plataforma.",
      lead: "La misma ingeniería atiende a la ciudad y a la operación privada — lo que cambia es el problema que resuelve.",
      cta: "Entrar por aquí",
